defmodule Desafio2Web.ProdutoControllerTest do
  ...
  @create_attrs %{descricao: "some descricao", nome: "some nome", preco: 120.5, quantidade: 42, sku: 42, barras: "420682048"}
  @update_attrs %{descricao: "some updated descricao", nome: "some updated nome", preco: 456.7, quantidade: 43, sku: 43,  barras: "420682048"}
